/*
 * Copyright 2009 The Microlog project @sourceforge.net Licensed under the
...
import com.github.lisicnu.log4android.factory.DefaultRepositoryFactory;
...
public class LoggerFactory {
	 ...
	 */
	private static final LoggerRepository loggerRepository = DefaultRepositoryFactory
	        .getDefaultLoggerRepository();

	/**
	 * The un-named logger. This is the classic Microlog method, that is used
	 * when no logger hierarchies are wanted.
	 * 
