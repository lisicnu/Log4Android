...
public final class Logger {
    ...
    private String name;
    private Level level;
    private boolean addDefaultLogger = true;
    ...
    public boolean isAddDefaultLogger() {
        return addDefaultLogger;
    }

    public void setAddDefaultLogger(boolean addDefaultLogger) {
        this.addDefaultLogger = addDefaultLogger;
    }
     ...
     * @throws IllegalArgumentException if the <code>level</code> is null.
     */
     ...
     *
     * @param message the message to log.
     * @param t       the <code>Throwable</code> object to log.
     */
