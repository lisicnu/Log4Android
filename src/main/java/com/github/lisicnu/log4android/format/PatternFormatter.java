...
import com.github.lisicnu.log4android.format.command.CategoryFormatCommand;
import com.github.lisicnu.log4android.format.command.ClientIdFormatCommand;
import com.github.lisicnu.log4android.format.command.DateFormatCommand;
import com.github.lisicnu.log4android.format.command.FormatCommandInterface;
import com.github.lisicnu.log4android.format.command.MessageFormatCommand;
import com.github.lisicnu.log4android.format.command.NoFormatCommand;
import com.github.lisicnu.log4android.format.command.PriorityFormatCommand;
import com.github.lisicnu.log4android.format.command.ThreadFormatCommand;
import com.github.lisicnu.log4android.format.command.ThrowableFormatCommand;
import com.github.lisicnu.log4android.format.command.TimeFormatCommand;
...
public class PatternFormatter implements Formatter {
	private static final String TAG = PatternFormatter.class.getSimpleName();
	...
	/**
	 * @see com.github.lisicnu.log4android.format.Formatter#setProperty(String,
	 *      String)
	 */
